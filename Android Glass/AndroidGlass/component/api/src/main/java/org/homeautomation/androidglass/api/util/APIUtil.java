package org.homeautomation.androidglass.api.util;
...
import org.homeautomation.androidglass.plugin.impl.DeviceTypeManager;
...
public class APIUtil {
	...
	public static String getMqttEndpoint() throws ConfigurationManagementException {
		String iotServerIP = Utils.replaceSystemProperty(AndroidGlassConstants.DEFAULT_ENDPOINT);
		iotServerIP = iotServerIP.replace(AndroidGlassConstants.LOCALHOST, getServerUrl());;
		PlatformConfiguration configuration = APIUtil.getTenantConfigurationManagementService().getConfiguration(
				AndroidGlassConstants.CONFIG_TYPE);
