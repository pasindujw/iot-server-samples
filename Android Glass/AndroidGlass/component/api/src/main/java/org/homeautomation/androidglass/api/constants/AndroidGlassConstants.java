...
package org.homeautomation.androidglass.api.constants;

public class AndroidGlassConstants {
    ...
    public static final String PERM_ENROLL_PICAVI = "/permission/admin/device-mgt/devices/enroll/androidglass";
