...
package org.homeautomation.androidglass.plugin.impl.util;
...
/**
 * Contains utility methods used by androidglass plugin.
 */
public class DeviceTypeUtils {

    private static Log log = LogFactory.getLog(org.homeautomation.androidglass.plugin.impl.util.DeviceTypeUtils.class);
