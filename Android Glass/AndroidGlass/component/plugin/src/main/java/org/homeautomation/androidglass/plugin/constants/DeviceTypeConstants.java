...
package org.homeautomation.androidglass.plugin.constants;
...
public class DeviceTypeConstants {
    public final static String DEVICE_TYPE = "androidglass";
    public final static String DEVICE_PLUGIN_DEVICE_NAME = "DEVICE_NAME";
    public final static String DEVICE_PLUGIN_DEVICE_SERIAL = "SERIAL";
    public final static String DEVICE_PLUGIN_DEVICE_ID = "androidtv_DEVICE_ID";
    public final static String STATE_ON = "ON";
    public final static String STATE_OFF = "OFF";

    //sensor events summerized table name
    public static final String SENSOR_TYPE1_EVENT_TABLE = "ORG_WSO2_IOT_DEVICES_s1";
    public static final String SENSOR_TYPE2_EVENT_TABLE = "ORG_WSO2_IOT_DEVICES_s2";
    public static final String DATA_SOURCE_NAME = "jdbc/androidtvDM_DB";
    public final static String DEVICE_TYPE_PROVIDER_DOMAIN = "carbon.super";
    public final static String SENSOR_TYPE1 = "at_response";
    public final static String SENSOR_TYPE2 = "s2";

    //mqtt tranport related constants
    public static final String MQTT_ADAPTER_NAME = "s1_mqtt";
    ...
    public static final String SUBSCRIBED_TOPIC = "carbon.super/androidglass/+/at_response";
    ...
    public final static String SENSOR_TYPE1_STREAM_DEFINITION = "org.wso2.iot.devices.at_response";
    public final static String SENSOR_TYPE1_STREAM_DEFINITION_VERSION = "1.0.0";

    public final static String SENSOR_TYPE2_STREAM_DEFINITION = "org.wso2.iot.devices.s2";
