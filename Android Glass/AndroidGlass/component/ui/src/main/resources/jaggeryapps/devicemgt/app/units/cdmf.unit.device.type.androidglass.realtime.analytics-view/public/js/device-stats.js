        ...
        var successCallBack = function (response) {
            ...
            $.each(devices, function (index, data) {
                var row = '<tr>' +
                    ...
                    '<form class="form-inline" action="/androidglass/device/{deviceId}/xbee-command" method="POST" data-payload="" id="form-xbee-' + data.edgeDeviceSerial + '-command">' +
